        ...
        <div class="col-lg-12">
            ...
            <div class="m-portlet">
                ...
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                      method="post"
                      action="{{ route('updateVisaOrder',['visa' => $visa->id,'order' => $order->id]) }}"
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-10">
                                ...
                                @endif
                                <span class="m-form__help">
                                    Please select pdf (if you want to update visa pdf).
                                </span>
                            </div>
                            <div class="col-lg-2">
                                <label>
                                ...
                                <div class="m-input-icon m-input-icon--right">
                                    <a target="_blank" href="{{ route('visaDownloadPdf',['visa' => $order->id]) }}"
                                       class="btn btn-primary">
                                        Download
                                    </a>
                                </div>
                        ...
                        <div class="m-form__actions m-form__actions--solid">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <a href="{{ route('visaOrders',['visa' => $visa->id]) }}" class="btn btn-secondary">
                                        Cancel
                                    </a>
                                </div>
                            </div>
