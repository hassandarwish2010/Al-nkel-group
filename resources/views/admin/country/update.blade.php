        ...
        <div class="col-lg-12">
            ...
            <div class="m-portlet">
                ...
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                      method="post"
                      action="{{ route('updateCountry',['country' => $country->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-4">
                                ...
                                <input type="text" name="name[en]" class="form-control m-input"
                                       ...
                                       value="{{ $country->name['en'] ? $country->name['en'] : old('name.en') }}">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="text" name="name[ar]" class="form-control m-input"
                                       ...
                                       value="{{ $country->name['ar'] ? $country->name['ar'] : old('name.ar') }}">
