        ...
        <div class="col-lg-12">
            ...
            <div class="m-portlet">
                ...
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                      method="post"
                      action="{{ route('storeNews') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="news[en]" class="form-control m-input"
                                       placeholder="Enter News content in english" value="{{ old('news.en') }}">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="news[ar]" class="form-control m-input"
                                       placeholder="Enter News content in arabic" value="{{ old('news.ar') }}">
