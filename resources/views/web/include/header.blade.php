    ...
    <header class="main-header" style="background-image: url('{{asset('public/assets/img/header-img.jpeg')}}')">
        <div class="trips">
            <ul class="list-unstyled text-center">
                <li class="active" data-show="plane"><i class="fas fa-plane-departure"></i>{{ __('alnkel.header-menu-flight') }}</li>
                <li data-show="garter-plane"><i class="fas fa-plane-departure"></i>رحلات الجارتير</li>
                <li data-show="trips-form"><i class="fas fa-globe-americas"></i>{{ __('alnkel.header-menu-travel') }}</li>
                <li data-show="passports"><i class="fas fa-passport"></i>{{ __('alnkel.header-menu-visa') }}</li>
            </ul>
                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="options aligen-items text-right" id="options">
                                            ...
                                            <label for="go_back">{{ __('alnkel.header-search-round-trip') }}</label>
                                            <input type="radio" id="go" name="options">
                                            <label for="go"> {{ __('alnkel.header-search-one-way') }}</label>
                                            <input type="radio" id="no_stop" name="options">
                                            <label for="no_stop"> {{ __('alnkel.header-search-stop') }} </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="container filter">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="d-block text-right" for="choose_country"> {{ __('alnkel.header-search-from') }}</label>
                                        <input class="form-control" id="choose_country" type="text"
                                               placeholder=" {{ __('alnkel.header-search-country-input') }}"><i class="fas fa-map-marker-alt"></i>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="d-block text-right" for="go_from"> {{ __('alnkel.header-search-to') }}</label>
                                        <input class="form-control" id="go_from" type="text" placeholder=" {{ __('alnkel.header-search-country-input') }}"><i
                                                class="fas fa-map-marker-alt"></i>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="d-block text-right" for="go_date"> {{ __('alnkel.header-search-date-out') }}</label>
                                        <input class="form-control" id="go_date" type="text" placeholder=" {{ __('alnkel.header-search-date-input') }}"><i
                                                class="far fa-calendar-alt"></i>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="d-block text-right" for="back_date"> {{ __('alnkel.header-search-date-out') }}</label>
                                        <input class="form-control" id="back_date" type="text"
                                               placeholder=" {{ __('alnkel.header-search-date-input') }}"><i class="far fa-calendar-alt"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="container filter">
                                <div class="row">
                                    <div class="col">
                                        <label class="d-block text-right" for="adult">{{ __('charter.adult') }}</label>
                                        <select class="form-control" id="adult">
                                            <option>1 بالغ</option>
                                        </select>
                                    </div>
                                    <div class="col">
                                        <label class="d-block text-right" for="childs">{{ __('charter.children') }}</label>
                                        <select class="form-control" id="childs">
                                            <option>0 الاطفال</option>
                                        </select>
                                    </div>
                                    <div class="col">
                                        <label class="d-block text-right" for="baby">{{ __('charter.baby') }}</label>
                                        <select class="form-control" id="baby">
                                            <option>0 رضع</option>
                                        </select>
                                    </div>
                                    <div class="col">
                                        <label class="d-block text-right" for="business_men"> {{ __('charter.business') }}</label>
                                        <select class="form-control" id="business_men">
                                            <option>0 رجل اعمال</option>
                                        </select>
                                    </div>
                                    <div class="col search-btn">
                                        <button class="main-button"><i class="fas fa-search"> </i>{{ __('alnkel.header-search-date-search') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
