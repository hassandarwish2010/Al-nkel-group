        ...
        <div class="col-lg-12">
            ...
            <div class="m-portlet">
                ...
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                      method="post"
                      action="{{ route('updateUserInvoice',['invoice' => $invoice->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="m-form__actions m-form__actions--solid">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <a href="{{ route('listUserInvoices') }}" class="btn btn-secondary">
                                        Cancel
                                    </a>
                                </div>
                            </div>
            ...
            <div class="m-portlet">
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption" style="position: relative;">
                        ...
                        <a href="{{route('downloadUserInvoice',['invoice' => $invoice->id, 'from' => $invoice->from_date, 'to'=>$invoice->to_date])}}" class="btn btn-primary" style="position: absolute;right: 10px;top: 20px;">
                            Download PDF
                        </a>
                    </div>
                </div>
                ...
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                      method="post"
                      action="{{ route('insertUserItem',['invoice' => $invoice->id]) }}" enctype="multipart/form-data">
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            <div class="col-lg-2">
                                <label>
                    ...
                    <table class="m-datatable" id="html_table" width="100%">
                        ...
                        @foreach($items as $item)
                            <tr>
                                ...
                                <td>
                                    @if($i == count($items))
                                    <a href="#!" data-url="{{ route('deleteUserItem',['item' => $item->id, 'invoice' => $invoice->id]) }}"
