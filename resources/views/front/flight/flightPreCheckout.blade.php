        ...
        <div class="container-fluid">
            ...
            <div class="inner-head-gp d-flex align-items-center justify-content-between">
                ...
                <div class="inner-prices d-flex align-items-center">
                    ...
                    <span>{{ __('alnkel.travel-cost') }}
                        : ${{ $flight->price['adult'] }} {{ __('alnkel.travel-person') }}
                        <b>|</b> ${{ $flight->price['children'] }}
                        {{ __('alnkel.travel-child') }} <b>|</b> ${{ $flight->price['baby'] }}
        ...
        @if(Auth::check())
            <!-- Start custom-form -->
                <form class="custom-form" method="post" enctype="multipart/form-data"
                    ...
                    {{--<label for="inputEmail4">{{ __('alnkel.single-travel-age') }}--}}
                    {{--<b>*</b>--}}
                    {{--</label>--}}
                    {{--<!-- Start custom-input -->--}}
                    ...
                    {{--<option value="adult" selected>{{ __('alnkel.single-travel-person') }}</option>--}}
                    {{--<option value="children">{{ __('alnkel.single-travel-child') }}</option>--}}
                    {{--<option value="baby">{{ __('alnkel.single-travel-baby') }}</option>--}}
                    {{--</select>--}}
                    {{--</div>--}}
                    ...
                    <!-- Start form-group -->
                        ...
                        <!-- Start form-group -->
                        <div class="form-group col-lg-2 col-md-4 custom-form-group">
                            <label for="inputEmail4">{{ __('alnkel.single-visa-select-age') }}</label>
                            <!-- Start custom-input -->
                            <div class="custom-input d-flex align-items-stretch">
                                <!-- Start input-icon -->
                                <div class="input-icon d-flex align-items-center">
                                ...
                                <select name="age[]" class="form-control">
                                    <option value="adult">{{ __('alnkel.visa-person') }}</option>
                                    <option value="children">{{ __('alnkel.visa-children') }}</option>
                                    <option value="baby">{{ __('alnkel.visa-baby') }}</option>
                                </select>
                                @if(isset($errors->messages()['age.0']))
                                    <div class="form-control-feedback" style="color: #f4516c;">
                                        {{  $errors->messages()['age.0'][0] }}
                    ...
                    <div class="action-btns d-flex align-items-center justify-content-end">
                        <a href="#" id="cloneForm"
                           class="btn-reset add-btn d-flex align-items-center justify-content-center"><i
                                    class="icons8-add-user-male"></i><span>{{ __('alnkel.single-travel-add-another-applicant') }}</span></a>
                        <button id="blockButton"
                                class="btn-reset submit-btn d-flex align-items-center justify-content-center"><i
                                    class="icons8-done"></i><span>{{ __('alnkel.single-travel-finish-application') }}</span>
                        </button>
                    </div>
                    <!-- End action-btns -->
                </form>
